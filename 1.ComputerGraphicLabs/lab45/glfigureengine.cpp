...
void GLFigureEngine::Enable(GLenum m){
    enableMods.push_back(m);
}
void GLFigureEngine::Disable(GLenum m){
    disableMods.push_back(m);
}


void GLFigureEngine::enable(){
    while(enableMods.size()){
        glEnable(enableMods.front());
        enableMods.pop_front();
    }
}
void GLFigureEngine::disable(){
    while(disableMods.size()){
        glDisable(disableMods.front());
        disableMods.pop_front();
    }
}
