...
void CuboidClass::calculatePolygons() {
    ...
    polygons->push_back(new RectPolygon3D(points[2], points[6], points[7], points[3]));
    polygons->push_back(new RectPolygon3D(points[7], points[6], points[5], points[4]));
    polygons->push_back(new RectPolygon3D(points[0], points[4], points[5], points[1]));
    polygons->push_back(new RectPolygon3D(points[1], points[5], points[6], points[2]));
    polygons->push_back(new RectPolygon3D(points[0], points[3], points[7], points[4]));
}
